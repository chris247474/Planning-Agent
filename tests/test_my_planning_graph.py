...
if __name__ == '__main__':
    ...
    if len(pg.a_levels[0]) is 3:
        print("Good length for action level 0")
    else:
        print("Bad length for action level 0 - should have been 3 but found {}".format(len(pg.a_levels[0])))
    if len(pg.a_levels[1]) is 6:
        print("Good length for action level 1")
    else:
        print("Bad length for action level 1 - should have been 6 but found {}".format(len(pg.a_levels[1])))
    '''
